...
class DashboardController extends Controller
{
    ...
    public function all()
    {
        ...
        $data['last_month_price'] = $this->getService('Order', true)->where('store_id', $store_id)->where('order_status', '>', 1)->where('pay_time', '<', Carbon::now()->startOfMonth()->startOfDay()->toDateTimeString())->where('pay_time', '>=', Carbon::now()->subMonths(1)->startOfMonth()->format('Y-m'))->sum('total_price'); // 上月销售额
